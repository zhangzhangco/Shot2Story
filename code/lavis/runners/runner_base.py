...
class RunnerBase:
    ...
    def re_evaluate_only(self):
        ...
        Set to True to skip training.
        """
        return self.config.run_cfg.re_evaluate
    ...
    def train(self):
        ...
        for cur_epoch in range(self.start_epoch, self.max_epoch):
            # training phase
            if not self.evaluate_only and not self.re_evaluate_only:
    ...
    @main_process
    def _save_checkpoint(self, cur_epoch, is_best=False, metric_save=dict()):
        """
